...
namespace assignsubmission_ltisubmissions\service\basicoutcomes\local\service;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class basicoutcomes extends \ltiservice_basicoutcomes\local\service\basicoutcomes {
    /**
    ...
    public function get_endpoint() {
        ...
        $url = new \moodle_url('/mod/assign/submission/ltisubmissions/service.php');
